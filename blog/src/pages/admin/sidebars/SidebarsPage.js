...
const SidebarsPage = () => {
  ...
  return (
    <div className="d-flex flex-column justify-content-between col-3 sidebar bg-dark" style={{ height: "100vh" }}>
      <div className="d-flex flex-column  bg-dark col-3"  style={{ width: "100%" }}>
      ...
      <div className="d-flex mb-2 flex-column align-items-center justify-content-center"  style={{ width: "100%" }}>
