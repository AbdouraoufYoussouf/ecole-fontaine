...
export const Dashboard = () => {
  const { users, roles, categories, articles, comments  } = useContext(AdminContext);
  ...
  const navigate = useNavigate()
    ...
    <div className="dashboard-container">
      <div 
        ...
        <FaSignOutAlt onClick={()=>logout(navigate)} size={35} className="icon-nav logout-icon"  color="tomato" />
      </div>
